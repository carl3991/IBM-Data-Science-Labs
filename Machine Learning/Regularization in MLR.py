...
# We'll take a deeper look at a multiple regression modeling scenario and compare performances of the three linear regression methods and then use the Lasso result to select important features to use in another modeling pass.
...
# ### Some immediate thoughts on these performance metrics
# 
